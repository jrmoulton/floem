...
use imaging::{BlurredRoundedRect, ClipRef, CustomPaintSink, FillRef, GlyphRunRef, GroupRef, PaintSink, StrokeRef};
...
impl VelloCpuRenderer {
    pub fn new(width: u32, height: u32) -> Result<Self> {
        ...
        Ok(Self(imaging_vello_cpu::VelloCpuRenderer::new(width, height)))
    }
